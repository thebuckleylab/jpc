...
def test_compute_pc_activity_grad_unsupervised(
...
def test_compute_hpc_param_grads(
...
def test_compute_bpc_activity_grad_pdm_mode(
...
def test_compute_epc_param_grads_different_param_types(
    key, x, y, input_dim, hidden_dim, output_dim, depth
):
