...
def test_compute_linear_equilib_energy(
    ...
    energy = linear_equilib_energy(params=(model, None), x=x, y=y)
...
def test_compute_linear_activity_hessian_with_skips(
    key, input_dim, hidden_dim, output_dim, depth
):
...
def test_compute_linear_activity_hessian_different_param_types(
    key, input_dim, hidden_dim, output_dim, depth
):
...
def test_compute_linear_activity_solution(
    key, x, y, input_dim, hidden_dim, output_dim, depth
):
    ...
    activities = compute_linear_activity_solution(
        model=model, x=x, y=y, use_skips=False, param_type="sp", activity_decay=False
    )
...
def test_compute_linear_activity_solution_with_skips(
    key, x, y, input_dim, hidden_dim, output_dim, depth
):
    ...
    activities = compute_linear_activity_solution(
        model=model, x=x, y=y, use_skips=True, param_type="sp", activity_decay=False
    )
