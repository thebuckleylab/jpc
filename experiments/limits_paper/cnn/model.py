...
class ScaledConv2d(eqx.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if param_type == "mupc":
            W = jr.normal(keys[1], conv.weight.shape, dtype=conv.weight.dtype)
...
class Readout(eqx.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if param_type == "mupc":
            W = jr.normal(keys[1], linear.weight.shape, dtype=linear.weight.dtype)
...
class ResNet(eqx.Module):
    ...
    def __init__(
        ...
        *,
        ...
        non_res_depth_scaling = (
            depth_scaling if (param_type == "mupc" and scale_non_res_layers) else 1.0
        )
        ...
        self.layers.append(
            Readout(
                ...
                scaling=non_res_depth_scaling / (in_features)
                if param_type == "mupc"
                else 1.0,
                param_type=param_type,
                use_bias=use_bias,
